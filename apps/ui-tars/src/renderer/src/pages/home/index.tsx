  ...
  return (
    <div className="w-full h-full flex flex-col">
      ...
      <div className="w-full h-full flex flex-col items-center justify-center">
         <div className="flex aspect-square size-32  items-center justify-center rounded-lg">
          {/* <img
            src={require('../../../../resources/logo-vector.png')}
            alt="Control Desktop Logo"
            className="w-24 h-24"
          />
           */}
